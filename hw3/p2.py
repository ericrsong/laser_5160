...
def sol(r,t):
    return r/(1+r) * np.exp(-(1+r)*t) + 1/(1+r)
...
t = np.array([0.01 * i for i in range(400)])
...
ax1.set_ylabel(r'$\Delta N / N_t$') # , color=color)
ax1.plot(t, N0, linestyle='solid', ms=1, color='tab:green', label=r'$I/I_{sat}=0$')
ax1.plot(t, N1, linestyle='solid', ms=1, color='tab:red', label=r'$I/I_{sat}=1$')
ax1.plot(t, N2, linestyle='solid', ms=1, color='tab:blue', label=r'$I/I_{sat}=2$')
ax1.plot(t, N3, linestyle='solid', ms=1, color='tab:brown', label=r'$I/I_{sat}=5$')
